            ...
            <div className="main-div">
                <div className="child-div">
                    ...
                    <div className="addItems">
                        ...
                        <div className="icon"><FaPlus onClick={() => dispatch(addtodo(inputdata), setinputdata(''))} /></div>
                    </div>
                    <div className="showitems">
                        {
                            list.map((ele) => {
                                return <div className="each-item" key={ele.id}>
                                    <h3>{ele.data}</h3>
                                    <div className="icon2"><FaRegTrashAlt title="delete" onClick={() => dispatch(deltodo(ele.id))} /></div>
                                </div>
                            })
                        }
